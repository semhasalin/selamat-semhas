...
(function ($, window, undefined) {
  Hangman = {
    ...
    win: function () {
      ...
      this.msgTitle.html("Asik!, Maaci Yang");
      // this is messy
      this.msgText.html("so when will we whatching agak laen Yang?");
      this.showMsg();
    },

    lose: function () {
      this.msgTitle.html("You Lost.. The Name is <span class='highlight'>" + this.wrd.word + "</span>");
      this.msgText.html("Cukup Tau :' ");
      this.showMsg();
    },
  };
